...
2.Criar banco de dados:
  -Criar um banco que sera usado no projeto(Inicialmente configurado para MySql nome do banco "competicao")

ALTERAR  -configurara no projeto a conexão com o banco (...\Competicao\config\database.php)
...
NAO 3.Configurara chave de criptografia:
...
ERRO DE BANCO	php artisan db:seed

7.Copiar o arquivo ".htaccess" para o diretório anterior a pasta do projeto (Competicao)

8.acessar projeto:
  -Acessar o projeto atraves do brawser: